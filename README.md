# 🧹 resolveCredentialGit (Git Cache Cleaner for Windows 11)
...
สคริปต์แบทช์ (`script.bat`) สำหรับลบแคชบัญชีผู้ใช้ Git และการตั้งค่า Config บน Windows 11 แบบอัตโนมัติ เหมาะสำหรับผู้ที่ต้องการเปลี่ยนบัญชี GitHub, GitLab หรือ Bitbucket ในเครื่องคอมพิวเตอร์ แต่ติดปัญหา Push/Pull ไม่ได้เพราะระบบจำบัญชีเดิมไว้
